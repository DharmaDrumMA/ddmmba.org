                        <article class="post error404 not-found" >
                            ...
                            <div class="entry-main">
                                ...
                                <div class="entry-content">
                                    ...
                                    <h3 class="entry-title"><?php _e( 'Oops! Page Not Found', 'phlox' ); ?></h3>
                                    <p class="message404" ><?php _e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'phlox' ); ?></p>
                                </div>
